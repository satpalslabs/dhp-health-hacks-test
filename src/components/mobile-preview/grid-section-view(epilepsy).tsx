...
const GridSectionComponent = ({
  ...
  return (
    <>
      ...
      {section.view_type == "grid" ? (
        <div className="mt-[14px] grid grid-cols-2 gap-3 px-6">
          {section.collections_data.map((collection, ix) => (
            <div
              key={ix}
              className="min-h-[170px] h-full w-full rounded-[10px] flex cursor-pointer group-data-[mode='dark']:bg-mobile-dark-article justify-center p-2 items-end text-mobile-text-firstSection "
              style={{
            ...
            >
              <div className="flex flex-col  items-center gap-[12px]">
                ...
                <div className="font-poppins font-semibold leading-5 text-base text-mobile-text-firstSection text-center px-[10px] h-fit min-h-[44px]">
          ...
          {section.sub_sections_data.map((sub_section, ix) => (
            <div
              key={ix}
              className="h-[190px] w-full rounded-[10px] flex cursor-pointer group-data-[mode='dark']:bg-mobile-dark-article justify-center items-center text-mobile-text-firstSection "
              style={{
            ...
            >
              <div className="flex flex-col  items-center gap-[12px]">
                ...
                <div className="font-poppins font-semibold leading-5 text-base tracking-tight text-mobile-text-firstSection text-center px-[10px] h-fit min-h-[44px]">
        ...
        <Swiper
          ...
          spaceBetween={20}
          grabCursor={true}
          enabled={section.view_type ? section.view_type == "horizontal" : true}
