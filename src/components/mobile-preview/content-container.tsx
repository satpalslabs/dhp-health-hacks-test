  ...
  switch (article.content_type?.type) {
    case "content-page":
      return (
        <div
          className={cn(
            "[&_svg]:h-[29px] [&_svg]:w-[71px] h-full flex flex-col gap-3 items-center justify-center",
            className
          )}
        >
          {article.source ? (
...
const CardDetails = ({ article }: { article: Article }) => (
  <div className="flex flex-col gap-3 group-data-[align='horizontal']:flex-col-reverse group-data-[align='horizontal']:my-auto w-full overflow-hidden">
    ...
    <div className="mt-[1px] flex flex-col gap-[6px] font-mulish text-base font-semibold px-4 leading-5  group-data-[mode='dark']:text-white group-data-[align='horizontal']:flex-col-reverse ">
