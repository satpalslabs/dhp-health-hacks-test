          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="no-tailwind ">
                <div
                  className="font-mulish [&_p]:!text-sm [&_p_*]:!text-sm [&_p]:!leading-[20px] [&_h2_*]:!text-[20.1px] [&_h2]:!leading-[21px] [&_h3_*]:!text-[18.1px] [&_h3]:!leading-[21px] [&_h1]:!leading-[28px] [&_h1]:!text-[21.1px] [&_h1_*]:!text-[21.1px]"
        ...
        return (
          <Collapsible className="group">
            ...
            <CollapsibleContent className="w-full mt-2">
              <div className="no-tailwind">
                <div
                  className="font-poppins [&_p]:!text-sm [&_p_*]:!text-sm [&_p]:!leading-[20px] [&_h2_*]:!text-[20.1px] [&_h2]:!leading-[21px] [&_h3_*]:!text-[18.1px] [&_h3]:!leading-[21px] [&_h1_*]:!text-[21.1px] [&_h1]:!leading-[28px] [&_h1]:!text-[21.1px]"
                  dangerouslySetInnerHTML={{ __html: item.content ?? "" }}
                />
              </div>
            </CollapsibleContent>
