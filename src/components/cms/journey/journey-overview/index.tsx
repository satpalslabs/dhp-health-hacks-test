...
import { handleJourneyDeletion } from "@/lib/journey-services";
import {
  Ban,
  Globe,
  Inbox,
              ...
              <>
                ...
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    const _updatedJourneys = data;
                    _updatedJourneys[activeJourneyIndex]._status =
                      journeyData._status == "published"
                        ? "unpublished"
                        : "published";
                    setJourneyData(_updatedJourneys[activeJourneyIndex]);
                    setData(_updatedJourneys);
                  }}
                >
                ...
                {journeyData && (
                  <>
                    ...
                    <ActionConfirmationDialog
                      ...
                      icon={<TriangleAlert />}
                      dialog_title="Delete Journey?"
                      dialog_description="Are you sure you want to delete this Journey? This action cannot be undone."
                      action={"Delete"}
                      handleAction={async () => {
