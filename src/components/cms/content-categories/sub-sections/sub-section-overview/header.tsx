...
const TableHeader = ({
  ...
  const collections = tableData
    .map((i) => i.collection)
    .filter((i): i is Collection => i != null);
  ...
  return (
    <Collapsible className="group font-inter">
      <div className="flex items-center justify-between">
          ...
          <DropdownMenu>
            ...
            >
              <SelectCollection
                ...
                options={[
                  ...new Set(
                    collections.map((i) => i.id).filter((i) => i != undefined)
                  ),
                ]}
              />
                  ...
                  onClick={() => {
                    if (selectedCollection) {
                      table
                        ...
                        ?.setFilterValue(selectedCollection.id);
                    } else {
                      table
                        .getColumn("content_path")
        ...
        <Button
          onClick={() => {
            ...
            router.push(`/sub-sections/${subSectionID}/article/add`);
          }}
        >
      ...
      <div className="flex gap-2">
        ...
        {selectedCollection &&
          table.getColumn("content_path")?.getFilterValue() != undefined && (
            <Button
              variant="ghost"
              className="text-button-filter-text mb-2 bg-button-filter-background font-inter dark:bg-accent dark:text-button-filter-background font-medium flex gap-1 items-center px-3 h-8 text-sm rounded-[12px]"
              onClick={() => {
      ...
      {selectedRows.length > 0 && (
        <>
          {selectedRows.length === 1 && (
            <>
              <Link
                href={`/sub-sections/${subSectionID}/article/edit/${selectedRows[0].id}`}
              >
    ...
    <div className="flex flex-col gap-2 font-inter ">
      ...
      <Popover>
        <PopoverTrigger asChild>
          ...
          >
            {selectedCollection ? (
              selectedCollection.collection_name.split("_")[0]
            ) : (
        ...
        <PopoverContent
          align="start"
          side="right"
          className="w-[280px] p-0 mt-0 ml-1"
        >
                  ...
                  .map((_collection, ix) => (
                    ...
                    >
                      <p className="line-clamp-1">
                        {_collection.collection_name.split("_")[0]}
                      </p>
                      <Check
                        className={cn(
                          "ml-auto",
